...
public class MidAutoBasic extends SequentialCommandGroup {
  /**
   * Creates a new MidAutoBasic.
   */
  public MidAutoBasic(DriveTrain driveTrain, Shooter shooter, Hopper hopper, Collector collector, ADIS16448_IMU imu) {
