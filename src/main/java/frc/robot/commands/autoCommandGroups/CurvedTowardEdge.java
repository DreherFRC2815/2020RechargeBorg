...
public class CurvedTowardEdge extends SequentialCommandGroup {
  /**
   * Creates a new LeftAutoBasic.
   */
  public CurvedTowardEdge(DriveTrain driveTrain, Shooter shooter, Hopper hopper, Collector collector, ADIS16448_IMU imu) {
